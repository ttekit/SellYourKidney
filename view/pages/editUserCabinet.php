                    ...
                    <div class="card mb-4 user-main-info">
                        <div class="card-body text-center user-main-info">
                            ...
                            <h5 class="my-3"><label class="w-100">
                                    <input class="user-edit-input" name="login" value="<?= $data["userData"]["login"] ?>"/>
                                </label></h5>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"><label class="w-100">
                                            <input class="user-edit-input" name="FullName" value="<?= $data["userData"]["FullName"] ?>"/>
                                        </label></p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"><label class="w-100">
                                            <input disabled class="user-edit-input" name="Email" value="<?= $data["userData"]["email"] ?>"/>
                                        </label></p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"><label class="w-100">
                                            <input class="user-edit-input" name="Phone" value="<?= $data["userData"]["Phone"] ?>"/>
                                        </label></p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"><label class="w-100">
                                            <input class="user-edit-input" name="Mobile" value="<?= $data["userData"]["Mobile"] ?>"/>
                                        </label></p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0"><label class="w-100">
                                            <input class="user-edit-input" name="login" value="<?= $data["userData"]["Address"] ?>"/>
                                        </label></p>
                                </div>
                            </div>
                        </div>
