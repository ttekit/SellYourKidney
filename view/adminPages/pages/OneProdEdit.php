...
<div class="content-wrapper adminBlogCont">
    ...
    <form method="post" action="./updateProd">
        <input name="id" class="d-none" value="<?= /** @var $data */
        $data["prodId"]?>"/>
        ...
        <div class="row">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="inputName" name="name" class="form-control" value="<?=$data["prodData"]["name"] ?>">
                        </div>
                        <div class="form-group">
                            <label for="inputDescription">Price</label>
                            <input id="inputDescription" class="form-control" name="price" type="number" value="<?=$data["prodData"]["price"]?>" />
                        </div>
                    </div>
                    <!-- /.card-body -->
                </div>
            ...
            <div class="col-md-6">
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <textarea id="summernote" class="main-content" name="content"> <?= $data["prodData"]["content"] ?></textarea>
                        </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
